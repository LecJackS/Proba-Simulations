...
grid()
transpa_color <- rgb(0, 0, 0, max = 255, alpha = 0, names = "transparent")
legend("bottomright", bg=transpa_color,legend=c("MaxVer", "EMom1", "EMom2", "Mediana"),
       col=c("blue", "red", "orange", "black"), lty=1, cex=0.8,
       box.lty=1)
# Varianzas
...
legend("topright", bg=transpa_color,legend=c("MaxVer", "EMom1", "EMom2", "Mediana"),
       ...
       box.lty=1)
# ECM 
plot(results_mv[,c(1,4)], col="blue", main="ECM", xlab="tamaño de muestra n", ylab="ECM", type="b", ylim=c(0.0,0.08), xlim=c(0,250))
